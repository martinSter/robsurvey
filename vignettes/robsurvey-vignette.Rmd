...
**robsurvey** complements the popular [survey](https://cran.r-project.org/web/packages/survey/index.html) package.

Multivariate outlier detection and imputation methods can be found in the R-package [modi](https://cran.r-project.org/web/packages/modi/index.html). 
